const Faq = () => {
  return (
    <div className="max-w-[1024px] mx-auto py-4 sm:px-8 lg:px-0">
      <div className="text-3xl text-center py-4">Frequently Asked Questions (FAQ)</div>
      <div className="flex flex-col gap-4">
        <div className="text-2xl">How does the Tezos NFT marketplace work?</div>
        <div>
      ...
      <div className="flex flex-col gap-4">
        <div className="text-2xl">What is the focus of the platform?</div>
        <div>
      ...
      <div className="flex flex-col gap-4">
        <div className="text-2xl">As an Artist , How do I sell an NFT on SomethingRare?</div>
        <div>
      ...
      <div className="flex flex-col gap-4">
        <div className="text-2xl">As a Collector, How do I buy an NFT ?</div>
        <div>
      ...
      <div className="flex flex-col gap-4">
        <div className="text-2xl">Curation Filter: "Chronological" versus "UNDER THE RADAR"</div>
        <div>
      ...
      <div className="flex flex-col gap-4">
        <div className="text-2xl">Marketplace Fees Structure & Royalties</div>
        <ul className="ml-8"><li className="list-disc">We charge a 5% fee for all sales, primary and secondary.</li><li className="list-disc">Artists can set a royalty fee between 0 and 10%. ( we think this is an accepted standard practice)</li></ul>
      </div>
      <div className="flex flex-col gap-4">
        <div className="text-2xl">How is the authenticity of a Tezos-based NFT verified?</div>
        <div>
      ...
      <div className="flex flex-col gap-4">
        <div className="text-2xl">What type of tokens can I mint?</div>
        <div>
      ...
      <div className="flex flex-col gap-4">
        <div className="text-2xl">IMPORTANT NOTICE:</div>
        <div>
